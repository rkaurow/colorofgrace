...
3. **List peserta** — `/admin/peserta.php`, menampilkan semua variabel peserta, dengan tombol **Kirim Ulang QR ke Email** dan **Cetak Gelang** di kolom paling ujung setiap baris.
4. **Daftar ulang** — `/admin/checkin.php`, scan QR Code dari layar HP (tahap 1).
5. **Masuk ruangan** — `/admin/masuk.php`, scan QR Code dari gelang (tahap 2).
...
| Peserta | `/admin/peserta.php` | List peserta, kirim ulang QR, cetak gelang |
