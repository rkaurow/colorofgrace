...
- [ ] Halaman sukses memberi tahu QR Code dikirim via email dan ditunjukkan saat check-in
...
- [ ] Tombol kirim ulang QR dan cetak gelang ada di kolom paling ujung
- [ ] Tombol kirim ulang QR berhasil mengirim ulang email
...
- [ ] Kamera atau scanner 2D berhasil membaca QR Code dari **layar HP**
- [ ] Scan otomatis ter-submit tanpa perlu klik tombol
- [ ] Scan QR Code valid menampilkan nama peserta
...
- [ ] Scan QR Code tidak dikenal menampilkan error
- [ ] Scan beruntun cepat tidak menghasilkan data ganda
- [ ] Kode huruf kecil dari scanner tetap dikenali
- [ ] Pencarian nama bekerja saat peserta lupa membawa QR Code
...
- [ ] QR Code di gelang berisi kode yang sama dengan di email
- [ ] Elemen antarmuka tersembunyi saat mencetak
- [ ] Hasil cetak muat pada gelang tanpa terpotong
- [ ] **QR Code hasil cetak berhasil dipindai scanner 2D**
...
- [ ] Scanner 2D berhasil membaca QR Code dari **gelang**
